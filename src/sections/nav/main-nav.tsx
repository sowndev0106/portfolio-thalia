        ...
        <nav className="fixed z-[100] text-white w-full py-4 shadow-[0px_1px_0px_0px_#FFFFFF40] bg-opacity-80 bg-black">
            <div className="container mx-auto flex justify-between items-center">
                ...
                <div className={`lg:flex lg:space-x-8 ${isOpen ? "block p-7 " : "hidden"} absolute lg:static top-[100%] left-0 w-full lg:w-auto  bg-opacity-90 bg-black lg:bg-transparent text-center lg:text-left`}>
                    <a href="#game-industry" className="block lg:inline-block hover:text-yellow-green py-2 lg:py-0">Game Industry</a>
                    <a href="#blockchain" className="block lg:inline-block hover:text-yellow-green py-2 lg:py-0">Blockchain</a>
                    <a href="#branding" className="block lg:inline-block hover:text-yellow-green py-2 lg:py-0">Branding</a>
                    <a href="#about-us" className="block lg:inline-block hover:text-yellow-green py-2 lg:py-0">About us</a>
                </div>
