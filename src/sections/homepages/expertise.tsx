import {
  brandingGuidelineBanners,
  brandingLogos,
  gameFiBanners,
  gamingCreativeBanners,
  inGameUXUIBanners,
  web3Banners,
} from "./data";
  ...
  return (
    <div
      ...
      className={`transition-opacity duration-500 ease-out ${
        isIntersecting ? "animate-moveUp" : "opacity-0 translate-y-5"
      }`}
    >
      {children}
    </div>
...
export default function Expertise() {
  return (
    <div
      className="mx-auto container  pt-10 scroll-smooth  scroll-mt-20 "
      id="our-expertise"
    >
      <div className="font-size-text-2xl font-bold w-full text-center text-yellow-green">
        My Expertise
      </div>
      ...
      <div className="pt-20 mx-5 sm:mx-0 ">
        <SectionWithAnimation>
          <GroupBannerSection
            groupBanners={gamingCreativeBanners}
      ...
      <div className="pt-20 mx-5 sm:mx-0  ">
        <SectionWithAnimation>
          <GroupBannerSection
            groupBanners={inGameUXUIBanners}
            title="In-game UI/UX"
            category="GAME INDUSTRY"
            numberRowShowOnMobile={1}
          />
        </SectionWithAnimation>
      </div>
      ...
      <div className="pt-20 mx-5 sm:mx-0 ">
        <SectionWithAnimation>
          <GroupBannerSection
            groupBanners={brandingGuidelineBanners}
