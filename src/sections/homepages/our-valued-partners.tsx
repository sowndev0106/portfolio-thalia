  ...
  return (
    <div>
      <div className="flex items-center justify-between flex-col">
        <div
          className={`font-size-text-2xl font-bold text-center mb-2 text-yellow-green`}
        >
          My Valued Partners
        </div>

        <div
          className={` text-white text-center text-[14px]  md:text-[22px] text-opacity-80`}
        >
          Discover the brands I’ve piroudly partnered with over the years.
        </div>
